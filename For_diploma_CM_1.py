...
X_train, X_test, y_train, y_test = train_test_split(X_subset, y_subset, test_size=0.25, random_state=42)
...
# Запуск эксперимента для Naive Bayes
nb_model = MultinomialNB(alpha=0.001)
accuracy = fit_and_evaluate(nb_model, X_train, y_train, X_test, y_test)
